...
```{r}
library("RSQLite")
connection <- dbConnect(drv=RSQLite::SQLite(), dbname="/Users/sumanth/Downloads/6101_Project_Data/wildfires_historic.sqlite")
tables <- dbListTables(connection)
tables <- tables[tables != "sqlite_sequence"]
cali_fires = dbGetQuery(conn=connection, statement=paste("SELECT * FROM 'Fires' WHERE STATE = 'CA'"))
rainfall <- read.csv("/Users/sumanth/Downloads/6101_Project_Data/rainfall_daily.csv")
soilmoisture <- read.csv("/Users/sumanth/Downloads/6101_Project_Data/soilmoisture_daily.csv")
airtemp <- read.csv("/Users/sumanth/Downloads/6101_Project_Data/airtemp_daily.csv")
```
...
final_wildfire <- merge(joined2, cleaned_fires, by.x="Year", by.y="FIRE_YEAR")
```
