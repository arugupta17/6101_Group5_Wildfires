...
fire_nature=final_wildfire[final_wildfire$STAT_CAUSE_DESCR %in% c('Lightning','Miscellaneous','Debris Burning'),]
table(fire_nature$month)
fire_peoplecause=final_wildfire[final_wildfire$STAT_CAUSE_DESCR %in% c('Arson','Campfire','Equipment Use','Fireworks','Powerline','Railroad','Smoking','Structue'),]
