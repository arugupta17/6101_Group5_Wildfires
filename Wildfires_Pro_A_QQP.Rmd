...
ggplot(a,aes(sample=gpa)) + geom_qq() + geom_qq_line()  + ggtitle("Gpa of admitted students(a)")
ggplot(a,aes(sample=gre)) + geom_qq() + geom_qq_line()  + ggtitle("Gre of admitted students(a)")
